...
type Recipient = { id: string; name: string; bank_name: string; account_number: string; account_holder: string; notes: string | null };
const empty = { name: "", bank_name: "", account_number: "", account_holder: "", notes: "" };
