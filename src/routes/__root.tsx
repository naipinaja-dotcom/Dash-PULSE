...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      { rel: "icon", type: "image/png", href: "/dash-icon-tab-v6.png?v=6" },
      { rel: "shortcut icon", type: "image/png", href: "/dash-icon-tab-v6.png?v=6" },
      { rel: "apple-touch-icon", href: "/dash-icon-tab-v6.png?v=6" },
